...
def astra_cone_tiled_booklets_geom_to_vec(geometry):
    ...
    print("astra_cone_tiled_booklets_geom_to_vec - vectors", vectors.shape)


    # repeat angles to simulate `odl_det_cols` times a 1-row acquisition
    angles = np.repeat(geometry.angles, odl_det_cols)
    print("astra_cone_tiled_booklets_geom_to_vec - angles", angles.shape)
    ...
    print("astra_cone_tiled_booklets_geom_to_vec - dparams", dparams.shape)
