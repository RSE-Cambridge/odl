...
__all__ = ('BookletsGeometry', 'ConeTiltedBookletsGeometry')
...
class ConeTiltedBookletsGeometry(BookletsGeometry, AxisOrientedGeometry):
    ...
    def __init__(self, apart, dpart, src_radius, det_radius,
        ...
        super(ConeTiltedBookletsGeometry, self).__init__(
    ...
    def __getitem__(self, indices):
        ...
        return ConeTiltedBookletsGeometry(apart, dpart,
